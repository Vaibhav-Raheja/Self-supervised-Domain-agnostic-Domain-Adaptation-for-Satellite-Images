...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf_path', type=str, default='configures.inria2sn2.dada_gen')
    ...
    try:
        ...
        print(f"Error: Module {args.conf_path} not found.")
        sys.exit(1)
    except AttributeError as e:
        print(f"Error: 'conf' not found in {args.conf_path}. Check the module for 'conf' definition.")
        sys.exit(1)
